...
```
Processing 2,500+ user event patterns...
...
--- Recommendations ---
  ...
  > Reduce shopping spending — currently 10.8% of income (recommended max 10%)
  > Your savings rate is 15.0% — aim for at least 20%
...
- **Configurable rule tables** — category limits and score weights defined as class constants, easy to extend
- **Separation of concerns** — event processing, scoring, and report generation are independent methods
- **Edge-case handling** — score clamped between 0–100, zero-division protected
---
